...
const projects: Project[] = [
  {
    ...
    description: "Web App for a healthy life! Explore the blog, sources, shop and more.",
  ...
  },
  {
    id: 2,
    title: "ACENDI APP",
    description: "Mindfulness app for everyday meditations! Explore it on your computer, iOS or Android device!",
...
const ProjectCarousel = () => {
  return (
    ...
    <Swiper spaceBetween={20} slidesPerView={1} modules={[Pagination]} pagination={{clickable: true}} navigation>
